...
Les stratégies de groupe (GPOs) sont des ensembles de règles qui permettent de :
- Configurer les paramètres des utilisateurs et ordinateurs
- Appliquer des politiques de sécurité
- Déployer des logiciels
- Standardiser l'environnement utilisateur

### 1.2. Objectifs Pédagogiques

À la fin de ce chapitre, vous serez capable de :
1. Créer et configurer des GPOs
2. Appliquer des stratégies par département
3. Déployer des logiciels via GPO
4. Dépanner les problèmes courants
