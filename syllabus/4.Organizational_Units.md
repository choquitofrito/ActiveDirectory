...
Pour le moment on a un domaine `computerelectronics.be` avec un DC et 2 machines clients, mais elles sont completement isolées. Grâce aux OUs (Unités d'Organisation), on va pouvoir les connecter.
