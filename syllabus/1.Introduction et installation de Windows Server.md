- [1. Les réseaux décentralisées VS centralisés avec Active Directory](#1-les-réseaux-décentralisées-vs-centralisés-avec-active-directory)
  - [Centralisation avec Active Directory](#centralisation-avec-active-directory)
  - [Exercice - Centraliser ou ne pas centraliser ?](#exercice---centraliser-ou-ne-pas-centraliser-)
...
## Centralisation avec Active Directory
...
## Exercice - Centraliser ou ne pas centraliser ?
