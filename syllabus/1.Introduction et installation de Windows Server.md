...
**Active Directory** est une base de données qui fonctionne comme un "annuaire téléphonique d'entreprise" numérique qui stocke des informations sur :
...
### 2.1.3. Création des réseaux virtuels
...
Le système vous demande de re-démarrer... faites-le!
...
On doit configurer le serveur pour qu'il soit accessible au réseau.

Nous pouvons configurer l'adresse IP de notre adaptateur de réseau depuis l'interface de configuration du serveur.

1. Ouvrez le **Gestionnaire de serveur** et faites clic sur **Serveur local** 
2. Clic sur l'adaptateur de réseau (ex : Ethernet) 
3. Clic droit puis **Propriétés**
4. Choisissez **Protocole Internet version 4 (TCP/IPv4)**
...
On peut à chaque moment obtenir l'**IP de notre serveur** grâce à la commande **ipconfig** dans une invite de commandes.
