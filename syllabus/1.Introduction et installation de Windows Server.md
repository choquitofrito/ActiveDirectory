...
- [2. Windows Server](#2-windows-server)
  ...
  - [2.2. Windows Server (1ère machine virtuelle)](#22-windows-server-1ère-machine-virtuelle)
...
![Infrastructure décentralisée vs centralisée](../diagrams/images/structure_centralisation.png)
...
## 2.2. Windows Server (1ère machine virtuelle)
...
- **Poste client** :
  - Nom : `pc01.computerelectronics.be`
...
3. Une fois l'installation terminée :
   ...
   - Renommez l'ordinateur avec un nom significatif (ex: **pc01.comptabilite**)
...
- Nom de la VM : **Client2Cours**
- Créez un compte local: **user1rh*, password **Password1** 
- Nom d'ordinateur : **pc01.rh**
