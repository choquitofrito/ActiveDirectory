...
## Point clé:
- Les postes de travail utilisent une structure DNS plate (directement sous le domaine racine ou **flat DNS**) pour simplifier la gestion des certificats et l'authentification unique (SSO)

- Les services et l'infrastructure utilisent des sous-domaines géographiques et d'environnement pour une meilleure gestion et isolation
...
- **Dernier niveau (appareils et services)**
  ...
  - **Zone US (192.168.20.0/24)** :
    ...
    - Périphériques réseau (192.168.20.20-49) :
      ...
      - `printer-ventes-02.computerelectronics.be` (192.168.20.21)
...
Exemple pratique :
  ...
  2. Vérification après quelques minutes :
     Zone Principale    : scanner-compta-02.computerelectronics.be et scanner-compta-03.eu.computerelectronics.be présents
     Zones Secondaires : scanner-compta-02.computerelectronics.be et scanner-compta-03.eu.computerelectronics.be présents
