...
2. **Machines virtuelles initiales**
   ...
   - Poste client : `ws-compta-01.eu.computerelectronics.be` (192.168.10.128)
...
1. **Flux d'authentification**
   - Un utilisateur sur `ws-compta-01.eu.computerelectronics.be` (192.168.10.128)
