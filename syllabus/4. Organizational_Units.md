...
- Un ordinateur dans l'OU `Europe/Comptabilité/Ordinateurs` peut avoir le nom DNS `ws-compta-01.eu.computerelectronics.be`
...
3. Déplacer les objets existants
   ...
   - Déplacer l'utilisateur `marie.dubois` vers `Europe/Comptabilité/Utilisateurs`
...
- Exemple : `marie.dubois`, `sophie.lambert`
...
Get-ADUser "marie.dubois" | Move-ADObject -TargetPath "OU=Utilisateurs,OU=Comptabilité,OU=Europe,DC=computerelectronics,DC=be"
