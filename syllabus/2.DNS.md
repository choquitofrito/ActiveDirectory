...
1. Un poste client (`ws-compta-01.eu.computerelectronics.be`) demande à `dns1` l'adresse de `www.google.com`
...
- Une requête pour ws-01.eu.computerelectronics.be
...
1. Requête pour ws-01.eu.computerelectronics.be :
...
![Requête Récursive](../diagrams/requetes_dns_recursive.png)
![Requête Itérative](../diagrams/requetes_dns_iterative.png)
...
- Les zones géographiques et d'environnement sont configurées ainsi :
  ```
...
- Si dns1 reçoit une requête pour ws-01.eu.computerelectronics.be, que se passe-t-il ?
...
2. Processus de résolution via dns1 :
   - dns1 reçoit la requête pour ws-01.eu.computerelectronics.be
...
Exemple pratique :
  ...
  1. Dans la zone principale uniquement :
     scanner-compta-02.eu.computerelectronics.be → 192.168.10.21
     scanner-compta-03.eu.computerelectronics.be → 192.168.10.22

  2. Vérification après quelques minutes :
     Zone Principale    : scanner-compta-02.eu.computerelectronics.be et scanner-compta-03.eu.computerelectronics.be présents
     Zones Secondaires : scanner-compta-02.eu.computerelectronics.be et scanner-compta-03.eu.computerelectronics.be présents
     ✓ Synchronisation réussie

  Cas pratique 2 - Ajout de deux serveurs de fichiers dans le département ventes :
  1. Dans la zone principale uniquement :
     fileserver-vnt-02.eu.computerelectronics.be → 192.168.10.50
     fileserver-vnt-03.eu.computerelectronics.be → 192.168.10.51

  2. Vérification après quelques minutes :
     Zone Principale    : fileserver-vnt-02.eu.computerelectronics.be et fileserver-vnt-03.eu.computerelectronics.be présents
     Zones Secondaires : fileserver-vnt-02.eu.computerelectronics.be et fileserver-vnt-03.eu.computerelectronics.be présents
     ✓ Synchronisation réussie
...
- **Exemple** : 
  ```
  ws-compta-01.eu.computerelectronics.be.    IN    A    192.168.10.101
  ```
...
- **Exemple** : 
  ```
  ws-compta-01.eu.computerelectronics.be.    IN    AAAA    2001:0db8:85a3:0000:0000:8a2e:0370:7334
  ```
...
- **Exemple** : 
  ```
  www.computerelectronics.be.    IN    CNAME    webserver-vnt-01.eu.computerelectronics.be.
  ```
...
www.ventes.eu.computerelectronics.be.    IN    CNAME  webserver-vnt-01.eu.computerelectronics.be.
```

2. Imprimante RH (sur dns1) :
```
printer-rh-01.eu.computerelectronics.be.    IN    A      192.168.10.31
printer-rh-02.eu.computerelectronics.be.    IN    AAAA   2001:0db8:85a3:0000:0000:8a2e:0370:7335
```
</details>

## Exercice 4.1 - Dépannage DNS

Scénario : Un utilisateur du département Ventes rapporte qu'il ne peut pas accéder à `ws-vnt-02.eu.computerelectronics.be`
...
2. Tester la résolution DNS :
   ```powershell
   nslookup ws-vnt-02.eu.computerelectronics.be
   ```

3. Vérifier la connectivité réseau :
   ```powershell
   ping ws-vnt-02.eu.computerelectronics.be
...
4. Vérification des enregistrements :
   ...
   nslookup ws-compta-01.eu.computerelectronics.be
   nslookup ws-rh-01.eu.computerelectronics.be
   ```
</details>
...
2. Test de la zone EU :
   ```powershell
   Resolve-DnsName -Name ws-compta-01.eu.computerelectronics.be
   Resolve-DnsName -Name ws-rh-01.eu.computerelectronics.be
   ```
