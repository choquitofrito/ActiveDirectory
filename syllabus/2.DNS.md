...
Ex: `pc01.ventes.computerelectronics.be` => `192.168.1.10`
...
- Il peut directement répondre que pc01.comptabilite.computerelectronics.be → 192.168.0.101
...
- **Exemple** : 
  ```
  pc01.comptabilite.computerelectronics.be.    IN    A    192.168.0.101
  ```
