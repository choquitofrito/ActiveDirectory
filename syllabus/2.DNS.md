...
- **Dernier niveau (appareils et services)**
  ...
  - **Zone Développement (192.168.30.0/24)** :
    ...
    - Services de développement (192.168.30.10-19) :
      ...
      - `test.dev.computerelectronics.be` (192.168.30.12)
  ...
  - **Zone Production (192.168.40.0/24)** :
    ...
    - Services de production (192.168.40.10-19) :
      ...
      - `web.prod.computerelectronics.be` (192.168.40.12)
...
Dans la structure actuelle de computerelectronics.be, identifiez et expliquez :
...
1. Appareils rattachés au domaine racine :
   ...
   Les serveurs DNS sont dans le domaine racine car ils doivent être accessibles par toutes les zones et gérer la résolution DNS pour l'ensemble de l'infrastructure.

2. Appareils de la zone EU (192.168.10.0/24) :
   - ws-01.eu.computerelectronics.be (192.168.10.128)
   - fileserver.eu.computerelectronics.be (192.168.10.1)

3. Appareils de la zone DEV (192.168.30.0/24) :
   - app.dev.computerelectronics.be (192.168.30.1)
   - db.dev.computerelectronics.be (192.168.30.2)
