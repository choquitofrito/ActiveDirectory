...
Concernant les services de DNS, **chaque serveur gère une zone** :
...
Dans une situation réelle on installera AD aussi sur `dns2.computerelectronics.be` (`10.0.1.11`), **qui contiendra une réplique de la base de données d'AD**. Ou peut-être même sur d'autres serveurs si on les avait !
