...
### 1.3 Relations entre DNS et AD DS
...
Accès aux ressources (flèche jaune) :
Une fois authentifié, PC-COMPTA accède au serveur de fichiers
SRV-FILES (10.0.1.20) fournit les ressources demandées
Réplication AD (flèche bleue bidirectionnelle) :
DC1 et DC2 (10.0.1.11) se synchronisent
