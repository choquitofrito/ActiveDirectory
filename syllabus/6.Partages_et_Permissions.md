...
Permission : Lecture seule pour le groupe 'COMPTA-STAGIAIRES'
Effet : Les stagiaires peuvent lire mais pas modifier les factures
```
...
Permission : Modification pour le groupe 'COMPTA-USERS'
Effet : Les comptables peuvent modifier les fichiers via le réseau
```
