# 1. Gestion des utilisateurs sans Active Directory

Pour gérer les Utilisateurs directement sur Windows Server, vous devez utiliser le menu **Gestion de l'ordinateur**.
...
## 1.4. Connexion des utilisateurs 
...
## 4.1. Création d'une tâche simple
...
## 4.2. Modification et d'autres actions sur une tâche
...
## 4.3. Exemple de création de tâches plus élaborées


## Exemple: Création d'une tâche de sauvegarde d'un fichier
...
## 4.4. Exercice pratique - Planificateur de tâches Windows
